...

{
    ...
    uint16_t nMacroUes = 50; // Number of users with realistic mobility model
    ...
    uint8_t Agent_ID=0; //Should 
    uint32_t GYMPORT=8001;
    //First ENV
    ...
    Agent_ID=2;
    GYMPORT=8003;
    Ptr<OpenGymInterface> openGymInterface3 = CreateObject<OpenGymInterface>(GYMPORT);
    Ptr<MyGymEnv> myGymEnv3 = CreateObject<MyGymEnv>(envStepTime, nMacroEnbSites, nCSpeedUes + nMacroUes, macroEnbBandwidth,Agent_ID,macroEnbDevs);
    myGymEnv3->SetOpenGymInterface(openGymInterface3);
   //Fourth   
    Agent_ID=3;
    GYMPORT=8004;
    Ptr<OpenGymInterface> openGymInterface4 = CreateObject<OpenGymInterface>(GYMPORT);
    Ptr<MyGymEnv> myGymEnv4 = CreateObject<MyGymEnv>(envStepTime, nMacroEnbSites, nCSpeedUes + nMacroUes, macroEnbBandwidth,Agent_ID,macroEnbDevs);
    myGymEnv4->SetOpenGymInterface(openGymInterface4);
    //Fifth
    Agent_ID=4;
    GYMPORT=8005;
    Ptr<OpenGymInterface> openGymInterface5 = CreateObject<OpenGymInterface>(GYMPORT);
    Ptr<MyGymEnv> myGymEnv5 = CreateObject<MyGymEnv>(envStepTime, nMacroEnbSites, nCSpeedUes + nMacroUes, macroEnbBandwidth,Agent_ID,macroEnbDevs);
    myGymEnv5->SetOpenGymInterface(openGymInterface5);        
    //Sixth
    Agent_ID=5;
    GYMPORT=8006;
    Ptr<OpenGymInterface> openGymInterface6 = CreateObject<OpenGymInterface>(GYMPORT);
    Ptr<MyGymEnv> myGymEnv6 = CreateObject<MyGymEnv>(envStepTime, nMacroEnbSites, nCSpeedUes + nMacroUes, macroEnbBandwidth,Agent_ID,macroEnbDevs);
    myGymEnv6->SetOpenGymInterface(openGymInterface6);    
    ...
    for (uint32_t it = 0; it != macroEnbs.GetN(); ++it) {
        ...
        enbPhy->TraceConnectWithoutContext("DlPhyTransmission", MakeBoundCallback(&MyGymEnv::GetPhyStats, myGymEnv3));
        enbPhy->TraceConnectWithoutContext("DlPhyTransmission", MakeBoundCallback(&MyGymEnv::GetPhyStats, myGymEnv4));
        enbPhy->TraceConnectWithoutContext("DlPhyTransmission", MakeBoundCallback(&MyGymEnv::GetPhyStats, myGymEnv5));
        enbPhy->TraceConnectWithoutContext("DlPhyTransmission", MakeBoundCallback(&MyGymEnv::GetPhyStats, myGymEnv6));
        
        enbPhy->TraceConnectWithoutContext("ReportCqiValues", MakeBoundCallback( & MyGymEnv::GetCQI, myGymEnv1));
        enbPhy->TraceConnectWithoutContext("ReportCqiValues", MakeBoundCallback( & MyGymEnv::GetCQI, myGymEnv2));
        enbPhy->TraceConnectWithoutContext("ReportCqiValues", MakeBoundCallback( & MyGymEnv::GetCQI, myGymEnv3));
        enbPhy->TraceConnectWithoutContext("ReportCqiValues", MakeBoundCallback( & MyGymEnv::GetCQI, myGymEnv4));
        enbPhy->TraceConnectWithoutContext("ReportCqiValues", MakeBoundCallback( & MyGymEnv::GetCQI, myGymEnv5));
        enbPhy->TraceConnectWithoutContext("ReportCqiValues", MakeBoundCallback( & MyGymEnv::GetCQI, myGymEnv6));
